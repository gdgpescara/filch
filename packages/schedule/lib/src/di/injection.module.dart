...
import 'package:schedule/src/presentation/schedule/cubit/schedule_cubit.dart'
    as _i307;
...
// initializes the registration of main-scope dependencies inside of GetIt
  ...
  _i687.FutureOr<void> init(_i526.GetItHelper gh) {
    gh.lazySingleton<_i679.ToggleSessionBookmarkUseCase>(
        () => const _i679.ToggleSessionBookmarkUseCase());
    gh.lazySingleton<_i679.IsSessionBookmarkedUseCase>(
        () => const _i679.IsSessionBookmarkedUseCase());
    ...
    gh.factory<_i307.ScheduleCubit>(
        () => _i307.ScheduleCubit(gh<_i558.GetGroupedSessionsUseCase>()));
  }
}

...
import 'package:auth/src/use_cases/count_users_with_t_shirt_use_case.dart' as _i714;
import 'package:auth/src/use_cases/count_users_without_t_shirt_use_case.dart' as _i173;
...
import 'package:auth/src/use_cases/user_password_sign_in_use_case.dart' as _i608;
...
class AuthPackageModule extends _i526.MicroPackageModule {
  ...
  _i687.FutureOr<void> init(_i526.GetItHelper gh) async {
    ...
    gh.lazySingleton<_i643.SignOutUseCase>(() => _i643.SignOutUseCase(gh<_i59.FirebaseAuth>()));
    gh.lazySingleton<_i1021.AppleSignInUseCase>(() => _i1021.AppleSignInUseCase(gh<_i59.FirebaseAuth>()));
    gh.lazySingleton<_i704.GetSignedUserUseCase>(() => _i704.GetSignedUserUseCase(gh<_i59.FirebaseAuth>()));
    gh.lazySingleton<_i461.IsStaffUserUseCase>(() => _i461.IsStaffUserUseCase(gh<_i59.FirebaseAuth>()));
